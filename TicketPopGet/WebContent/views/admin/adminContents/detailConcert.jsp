<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.kh.admin.adminContents.model.vo.*"%>
<%
	        ...
	        <div id="contentInsertDiv">
                <table id="contentInsert" style="width:450px">
                    ...
                    <tr>
                        ...
                        <th>공연날</th>
                        <td><input type="date" id="startDate" name="startDate" value="<%=c.getContentDate() %>" required disabled></td>
                    ...
                    <tr>
                        <th>공연시간</th>
                        <td><input type="text" id="startTime" name="startTime" value="<%=c.getStartTime() %>" required disabled></td>
                        <td><input type="text" id="endTime" name="endTime" value="<%=c.getEndTime() %>" required disabled></td>
           
                    </tr>
                    <tr>
                        <th>총티겟수</th>
                        <td colspan="2"><input id="ticketCount" type="number" min="0" value="<%=c.getMax()%>" name="ticketCount" required disabled></td>
                    </tr>
                    <tr>
                        <th>장소</th>
