...
<body>
	...
	<div class="detailed_search" align="center">
			...
			<div class="search_result1">
				<p style="height: 50px; font-size: 30px;">
					<span style="color: red; font-weight: bold; line-height: 120px;">'검색'</span>
					에 대한 검색 결과 입니다.
				</p>
				<div id="search_result1" style="margin-top: 55px;">
					...
					<button id="search_button1">
						<img src="/TicketPopGet/resources/img/imgForSearch/search.png" width="30px" height="30px">
					</button>
				</div>
			</div>
			...
			<div class="search_result2">
				<!-- 지역 -->
				<ul>
					<li><select style="margin-left: 40px; width: 150px; height: 30px;">
							<option>지역</option>
				...
				<!-- 분류 -->
				<ul>
					<li><select style="margin-left: 30px; width: 150px; height: 30px;">
							<option>분류</option>
							<option>콘서트</option>
							<option>연극</option>
							<option>전시</option>
		...
		<div class="search_result3">
			...
			<div class="search_result_list">
				...
				<div id="search_result_img" style="margin-left: 70px;">
					<a href=""><img
						src="/TicketPopGet/resources/post_upfiles/111111111111.PNG"
						width="150"></a>
				</div>
				<!-- 검색내용 -->
				<div id="search_result_content">
					...
					<p>
						장 소 : 장소입니다 <br> 기 간 : 기간입니다 <br> 가 격 : 가격입니다 <br>
					</p>
				</div>
				<!-- 예매상황 // 진행중 -->
			...
			<div class="search_result_list">
				...
				<div id="search_result_reservation">
			        ...
			        <!-- 페이징바 -->
        <div class="pagination" style=" margin-top:1050px; margin-left:600px; ">
