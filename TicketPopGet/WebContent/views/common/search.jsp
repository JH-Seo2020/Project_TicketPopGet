...
<style>
/* 공통사항 */
#search_result1 input, #search_button1, #search_button2:focus {
	outline: none;
}
	...
	<div class="detailed_search" align="center">
		<form atcion="" method="">
			...
			<div class="search_result2">
				...
				<ul>
					<li><select
						style="margin-left: 40px; width: 150px; height: 30px;">
							<option>지역</option>
				...
				<ul>
					<li><select
						style="margin-left: 30px; width: 150px; height: 30px;">
							<option>분류</option>
							<option>콘서트</option>
							<option>연극</option>
							<option>전시</option>
				...
				<!-- 관람기간 -->
				<ul>
					<li style="margin-left: 30px; font-size: 17px;">관람기간
					   <input type="date" style="width: 150px; height: 30px; margin-left: 5px;">
