...
<body>
	...
	<div id="wrap_adlist">
        ...
        <div id="adBoardBtn">
            <a href="<%=contextPath %>/adboard.genre?genre=콘서트&currentPage=1" class="btn btn-outline-warning btn-lg">콘서트</a>
            <a href="<%=contextPath %>/adboard.genre?genre=연극&currentPage=1" class="btn btn-outline-warning btn-lg">연극</a>
            <a href="<%=contextPath %>/adboard.genre?genre=전시&currentPage=1" class="btn btn-outline-warning btn-lg">전시</a>
        </div>
