...
<style>
#delete_detail{margin-left:250px; }
		...
		<div class="delete_write">
			...
			<div
				...
				<p>전자상거래 등에서의 소보자 보호에 관한 법률 제 6조에 의거 서명, 주소등 거래의 주체를 식별할 수 있는
					정보에 한하여 서비스 이용에 관한 동의를 철회한 경우에도 이를 보존할 수 있으며, 동법 시행령 제6조에 의거 다음과 같이
					거래 기록을 보관합니다.</p>
				<ul>
			...
			<div style="margin-top: 45px;  margin-left:15px; border-top: 1px solid silver; width: 900px;">
				...
				<table id="delete_reason">
					<tr>
						<td><input type="radio" name="cause" id="cause1"> 
						<label for="cause1">개인정보유출 우려</label></td>
						<td><input type="radio" name="cause" id="cause2"> <label
							for="cause2">탈퇴 후 재가입</label></td>
						<td><input type="radio" name="cause" id="cause3"> <label
							for="cause3">서비스 기능 불편</label></td>
					</tr>
					<tr>
						<td><input type="radio" name="cause" id="cause7"> <label
							for="cause7">시스템 오류</label></td>
						<td><input type="radio" name="cause" id="cause8"> <label
							for="cause8">사이트 이용안함</label></td>
					</tr>
					<tr>
						<!-- 기타 클릭시 text 이용할 수 있게 설정하기 -->
						<td><input type="radio" name="cause" id="cause9"> <label
							for="cause9">기타</label></td>
					</tr>
					<tr>
						<td colspan="3"><textarea
								style="width: 700px; height: 90px; resize: none;"></textarea></td>
					</tr>
				</table>
			</div>

			<div style="margin-top: 90px; margin-left: 250px;">
				<input type="radio" onclick="" style="width: 20px; height: 16px;"
					id="delete_ok"> <label for="delete_ok"
					style="font-size: 20px;">위, 모든 내용을 확인했으며 동의합니다</label>
			</div>
		</div>
