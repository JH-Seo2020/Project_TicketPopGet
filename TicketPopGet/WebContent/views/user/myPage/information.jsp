...
<body>
	...
	<div align="center" style="width: 800px; height:500px; margin-left: 450px; margin-top: 100px;">
		...
		<ul class="nav nav-tabs nav-justified" style="margin-top: 60px;">
			...
			<li class="nav-item"><a class="nav-link" style="color: black;" href="change_pwd.jsp">비밀번호변경</a></li>
			<li class="nav-item"><a class="nav-link" style="color: black;" href="delete.jsp">회원탈퇴</a></li>
		</ul>
		...
		<div style="width: 500px; margin-top: 30px; border-top: 1px solid orange; border-bottom: 1px solid orange;">
			...
			<div style="margin-bottom: 30px;">
				<button onclick="location.href='information_detail.jsp'" class="btn" style="border: 1px solid orange; background: orange; color: white;">확인</button>
				&nbsp;&nbsp;
