		...
		<div class="mypage_left">
			...
			<div id="mypage_menu">
				<ul>
					...
					<li><a class="mypage_menu_a" href="<%=contextPath%>/review.my?currentPage=1&userId=<%=loginUser.getUserId()%>">나의 관람후기</a></li>
					<li><a class="mypage_menu_a" href="<%=contextPath%>/adboard.my?currentPage=1&userId=<%=loginUser.getUserId()%>">나의 홍보 글</a></li>
				</ul>
			</div>
		</div>
		<!-- 중앙 컨텐츠 -->
