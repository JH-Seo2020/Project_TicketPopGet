  ...
  <div class="row">
    <div class="col-xs-12 ">
      ...
      <nav>
        <div class="nav nav-tabs nav-fill" id="nav-tab">
          <div class="step1">step1<br><b>관람일/회차</b></div>
          <div class="step2">step2<br><b>결제방법</b></div>
        </div>
      </nav>
        ...
        <div>
            ...
            <div id="datepicker">
              <script>
                ...
                $("#datepicker").on("change",function(){
                    ...
                    $("#selectDate>span").text(exhibitionDay);   //고른 날짜 표기
                });
              </script>
            </div>
          </div>
          ...
          <div class="listArea">
            ...
            <br>
            <div id="selectDate">
     		선택날짜 : <span></span> <br><br></div>
              <div class="select">
                <b>회차선택</b><br>
                <button id="playTime">[1회] 15시 00분</button><br>
    ...
    <div>
      ...
      <table width=220px>
        ...
        <button id="nextBtn"  class="btn btn-warning">다음단계</button>
    </div>
  </div>
</body>
</html>