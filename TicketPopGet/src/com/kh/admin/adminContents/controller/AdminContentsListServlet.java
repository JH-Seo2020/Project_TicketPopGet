...
/**
 * Servlet implementation class AdminContentsListServlet
 */
@WebServlet("/list.adco")
public class AdminContentsListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminContentsListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/admin/adminContents/adminContentsList.jsp").forward(request, response);
	}
