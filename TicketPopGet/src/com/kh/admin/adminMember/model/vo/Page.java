...
public class Page {
	...
	private int endPage;			// 현재 페이지에 하단에 보여질 페이장 바의 마지막수
	
	public Page() {}

	public Page(int listCount, int currentPage, int pageLimit, int boardLimit, int maxPage, int startPage,
			int endPage) {
		super();
	...
	public String toString() {
		return "Page [listCount=" + listCount + ", currentPage=" + currentPage + ", pageLimit=" + pageLimit
