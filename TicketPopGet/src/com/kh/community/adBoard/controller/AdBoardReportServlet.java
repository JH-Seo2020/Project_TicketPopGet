...
/**
 * Servlet implementation class AdBoardReportServlet
 */
@WebServlet("/community.report")
public class AdBoardReportServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdBoardReportServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int adContentNo = Integer.parseInt(request.getParameter("adContentNo"));
		...
		if(result>0) {
			...
			response.sendRedirect(request.getContextPath() + "/adboard.detail?boardNo="+adContentNo);
		}else {
