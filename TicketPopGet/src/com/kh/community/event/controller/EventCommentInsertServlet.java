...
/**
 * Servlet implementation class EventCommentInsertServlet
 */
@WebServlet("/comment.insert")
public class EventCommentInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EventCommentInsertServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new EventService().insertComment(comm);
