...
/**
 * Servlet implementation class EventCommentListServlet
 */
@WebServlet("/comment.co")
public class EventCommentListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EventCommentListServlet() {
        super();
...
//		System.out.println(eventNo);
		...
		//sql에서 개수조회
		listCount = new EventService().selectCommentCount(eventNo);
		...
		ArrayList<Comment> list = new EventService().selectComment(pi,eventNo);
