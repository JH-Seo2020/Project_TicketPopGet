...
/**
 * Servlet implementation class EventCommentReportServlet
 */
@WebServlet("/comment.report")
public class EventCommentReportServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EventCommentReportServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boardReport.setAdContentNo(commentNo);
