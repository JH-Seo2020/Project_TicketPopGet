...
/**
 * Servlet implementation class EventResultListServlet
 */
@WebServlet("/event.result")
public class EventResultListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EventResultListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//이벤트 결과물 게시글 개수 조회 
		listCount = new EventResultService().eventResultListCount();
		//현재페이지
		...
		ArrayList<EventRaffle> list = new EventResultService().selectList(pi);
