...
/**
 * Servlet implementation class ReviewReplyListServlet
 */
@WebServlet("/reply.co")
public class ReviewReplyListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewReplyListServlet() {
        super();
...
//		System.out.println(listCount);
		...
		ArrayList<Reply> list = new ReviewService().selectReply(pi,reviewNo);
