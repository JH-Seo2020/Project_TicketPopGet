...
/**
 * Servlet implementation class MyPage_reservation
 */
...
public class MyPageReservation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userNo>0) {
			...
			listCount = new MyPageService().selectReservationListCount(userNo);
			...
			ArrayList<Reservation> re = new MyPageService().selectReservationList(userNo, pi);
