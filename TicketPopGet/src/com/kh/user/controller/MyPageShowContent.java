...
public class MyPageShowContent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPageShowContent() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userNo>0) {
			...
			listCount = new MyPageService().selectShowContnetCount(content,userNo);
			...
			ArrayList<MyPage> mps = new MyPageService().selectShowContnetList(userNo, pi, content);
