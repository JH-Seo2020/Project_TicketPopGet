...
/**
 * Servlet implementation class MyPageWishContent
 */
@WebServlet("/wishContent.my")
public class MyPageWishContent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPageWishContent() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        listCount = new MyPageService().selectWishContentCount(userNo, content);
		...
		ArrayList<WishList> wishlist = new MyPageService().selectWishContentList(userNo, pi,content);
